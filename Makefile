...
avr32:
	...
	avr32-gcc -std=c99 -c src/MOD_Pattern.c -Iinclude -o obj/MOD_Pattern.o -O3
	avr32-gcc -std=c99 -c src/MOD_PatternDivision.c -Iinclude -o obj/MOD_PatternDivision.o -O3
